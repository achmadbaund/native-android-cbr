...
import android.widget.AdapterView.OnItemClickListener;
	...
	public class KasusBaru extends Activity implements OnClickListener {
		...
		public void SimpanKasus(View view){
				...
				DBAdapter db = DBAdapter.getDBAdapterInstance(KasusBaru.this);
				db.openDataBase();
		        ...
		        initialValues.put("Paket_solusi",sl.getText()+"");		        
		        ...
		        DBAdapter db1 = DBAdapter.getDBAdapterInstance(KasusBaru.this);
				db1.openDataBase();
			 	db1.insertRecordsInDB("Tabel_kasus1",null,initialValues);
		        c.close(); 
		        db.close();
		        db1.close();
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(KasusBaru.this);
				builder.setMessage("Kasus baru sudah ditambahkan, Apakah Anda Ingin menambahkan data lagi? ").setCancelable(false)
				.setPositiveButton("Ya",new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog,int id) {
						i = new Intent(KasusBaru.this, KasusBaru.class);
						startActivity(i);
						finish();
					} 
				})
				.setNegativeButton("Tidak, kembali ke menu utama",new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id)
					{
						i = new Intent(KasusBaru.this, MainActivity.class);
						startActivity(i);
						finish();
					}
				}
		...
		public void but_SearchClick(View view){
	    	try{
	            mListUsers = getActivities();               
			 	adapter = new GejalaAdapter(KasusBaru.this, mListUsers);
