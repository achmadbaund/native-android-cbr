...
public class RekomendasiMakanan extends Activity implements OnClickListener{
	...
	private String saur, beratsaur, _id, jarak, total_kalori, nama, makansg,
			...
			cemilml, brtcmilml, waktu_makan, nama_makanan, delimiter, LIST_GEJALA, kategori_BB;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, MENUNYA + "P"+SOLUSINYA +"M"+MENUNYA, Toast.LENGTH_LONG).show();
		...
		kategori_BB = sharedPreferences.getString("kategoriBB", "");
		...
		pesan.setText("Waktunya makan " + nama + ".\n Sesuai dengan data yang anda masukkan : \n\nGolongan Berat Badan : " + kategori_BB + "\n Kebutuhan kalori anda : " + EnergiKkal + "\n\n Rekomendasi Makanan untuk diet "+MENUNYA+" Kkal adalah sebagai berikut :");
